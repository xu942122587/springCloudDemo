...
public class ArrayUtils {
	 ...
	 * @return 包装类型数组或对象数组
	 * @throws IllegalArgumentException 对象为非数组
	 */
	public static Object[] wrap(Object obj) {
		...
		throw new IllegalArgumentException(StringUtils.format("[{}] is not Array!", obj.getClass()));
	}
	...
	public static <T> String join(T[] array, CharSequence conjunction) {
		...
		for (T item : array) {
			...
			if (ArrayUtils.isArray(item)) {
				sb.append(join(ArrayUtils.wrap(item), conjunction));
