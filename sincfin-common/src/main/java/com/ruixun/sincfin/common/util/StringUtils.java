...
public class StringUtils {
	 ...
	 * 
	 * <p>
	 * 注意，和<code>String.trim</code>不同，此方法使用<code>NumberUtils.isBlankChar</code>
	...
	public static String trim(CharSequence str, int mode) {
		...
		// 扫描字符串头部
		if (mode <= 0) {
			while ((start < end) && (NumberUtils.isBlankChar(str.charAt(start)))) {
				start++;
			}
		}
		...
		// 扫描字符串尾部
		if (mode >= 0) {
			while ((start < end) && (NumberUtils.isBlankChar(str.charAt(end - 1)))) {
				end--;
			}
		}
	...
	public static String cleanBlank(CharSequence str) {
		...
		for (int i = 0; i < len; i++) {
			c = str.charAt(i);
			if (false == NumberUtils.isBlankChar(c)) {
				sb.append(c);
			}
		}
		return sb.toString();
	 ...
	 * @return
	 */
	public static boolean formNumbersAndLetters(String str) {
	...
	public static boolean matches(String str, String matches) {
	 ...
	 * @date 2018年4月3日 上午10:37:00
	 */
	public static String realNameEncryption(String realName) {
